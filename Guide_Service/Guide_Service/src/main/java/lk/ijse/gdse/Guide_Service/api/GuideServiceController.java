...
//            System.out.println(guide);
    ...
    public ResponseUtil getGuideDetailsById(@PathVariable String contactNumber) {
        Optional<Guide> guideById = guideService.getByContactNumber(contactNumber);
        if (guideById.isPresent()) {
            return new ResponseUtil(200,"found",guideById);
        } else {
